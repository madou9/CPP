...
/*   Updated: 2023/12/14 18:09:28 by ihama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ClapTrap
{
    ...
    unsigned int _hitPoint; //Hit points (10), represent the health of the ClapTrap
    unsigned int _EnergyPoint; //Energy points (10)
