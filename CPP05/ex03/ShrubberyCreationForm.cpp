...
/*   Updated: 2024/03/01 18:24:21 by ihama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ShrubberyCreationForm::executeFormAction() const {
    ...
    if (createFile.is_open()) {
        // Write ASCII art to the createFile
        createFile <<
			"         /X/ \n" 
			"         -A-  \n"
			"        -ALI-  \n"
			...
			"        -###- \n" ;
        createFile.close();
        std::cout << "shrubberyCreationForm: YESSSS Check we create a new createFile  created successfully! inside the work station" << std::endl;
    } else {
